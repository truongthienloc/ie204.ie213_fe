...
export default function RemoveDiscountModal({ isOpen, onClose, onSubmit }: Props) {
  if (!isOpen) {
    return null;
  }
        ...
        <div className="relative ">
          ...
          <div className="relative flex w-full flex-col rounded-xl border-[3px] border-primary bg-[#fff8ee] outline-none focus:outline-none">
            <div className="flex flex-col justify-center px-10 pt-8">
              <center>
                <p className="w-[260px] font-medium">Bạn có chắc chắn muốn xóa khuyến mãi này không ?</p>
              </center>
            </div>
