...
export default function BasicModal({ title, open = false, onClose, children, buttons, className }: Props) {
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        ...
        <div className="flex flex-row items-center justify-end gap-2 border-t border-black p-4">{buttons}</div>
      </div>
    </Modal>
  );
}
