    ...
    <>
      <StyledTableRow className={styles['card__wrapper']}>
        <StyledTableCell component="th" scope="row">
          <img alt="Product image" src={product?.dishImages[0].link} className={styles['card__image']} />
        </StyledTableCell>
        <StyledTableCell className={styles.text}>{product?.dishName}</StyledTableCell>
        <StyledTableCell className={styles.text}>{formatCurrency(product?.dishPrice) + ' VNĐ'}</StyledTableCell>
