  ...
  return (
    <div className="flex h-[300px] flex-row items-center gap-5 overflow-hidden">
      <div className="w-2/3 text-white">
        <Link className="flex flex-row  items-center gap-4" href={`/product/${dish.slugName}`}>
          <div className="h-[260px] w-1/2 overflow-hidden rounded-2xl">
            <img className="h-full w-full object-cover" src={dish.dishImages[0].link} alt={dish.dishName} />
          </div>
