    ...
    const fetchFoodByKind = async () => {
      try {
        if (choice === 1) {
          ...
          const mainDishData = await filterDish(0, 10000000, '6608301dc11b247adbd84f28', 1, 20);
          setProducts(mainDishData);
        } else if (choice === 3) {
          const dessertData = await filterDish(0, 10000000, '66083088c11b247adbd84f29', 1, 20);
          setProducts(dessertData);
        } else if (choice === 4) {
          const drinksData = await filterDish(0, 10000000, '66083097c11b247adbd84f2a', 1, 20);
