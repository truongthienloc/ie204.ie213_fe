...
const PaymentOptionButtons: React.FC<ChildProps> = ({ isShip, isPayDirected, updateStateTrue, updateStateFalse }) => {
    ...
    <div>
      {!isShip && (
        <div className="flex flex-row gap-3">
          <button className={`${style.OptionButtons} ${isPayDirected ? style.active : ''}`} onClick={setPayDirectTrue}>
            <LocalAtmIcon />
