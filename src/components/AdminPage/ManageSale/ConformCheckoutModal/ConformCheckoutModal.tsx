...
export default function ConformCheckoutModal({ isOpen, id, customerName, onClose, onSubmit }: Props) {
  return (
    <Modal
      ...
      buttons={
        <>
          <ModalButton className="bg-red-500 hover:border-red-500 hover:text-red-500" label="Hủy" onClick={onClose} />
          <ModalButton
