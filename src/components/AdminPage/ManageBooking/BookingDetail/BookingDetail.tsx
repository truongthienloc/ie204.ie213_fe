  ...
  return (
    <tr>
      ...
      <td className="border-b border-gray-200 px-4 py-4 text-center">
        {status === 'Available' ? (
          <span className="text-nowrap rounded-full bg-green-100 px-2 py-1 text-base text-green-800">Còn trống</span>
        ) : (
          <span className="text-nowrap rounded-full bg-red-100 px-2 py-1 text-base text-red-800">Đã được đặt</span>
        )}
      </td>
      <td className="border-b border-gray-200 px-4 py-4 text-center">
        {time ? (
