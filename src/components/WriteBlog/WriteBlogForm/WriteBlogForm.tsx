    ...
    <div className="container flex flex-col gap-4 py-4">
      ...
      <div className="flex flex-col gap-1">
        ...
        <div className="flex w-full flex-row flex-wrap gap-1">
          {keywords.length > 0 &&
            keywords.map((key) => (
              <Chip color="primary" key={key} label={key} onDelete={() => handleDeleteKeyword(key)} />
            ))}
        </div>
      </div>
      ...
      <div className="flex flex-row items-center">
        <button className="rounded-md bg-primary px-3 py-2 text-white" onClick={handleSubmit} type="button">
