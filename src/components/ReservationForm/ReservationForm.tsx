    ...
    <div className="flex min-w-[425px] flex-col gap-8 rounded border-2 border-primary p-8">
      <div className="flex flex-col gap-4">
        ...
        <LocalizationProvider dateAdapter={AdapterDayjs}>
          ...
          <div className="flex flex-row items-center justify-between gap-2">
            ...
            <TimePicker className="flex-[2]" format="HH:mm" value={time} onChange={onTimeChange} disabled={!isOpen} />
          </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-row items-center gap-2">
          ...
          <OutlinedInput className="flex-[2] [&_input]:text-center" placeholder="15" value={tableName} disabled />
        </div>
      </div>
      <button
