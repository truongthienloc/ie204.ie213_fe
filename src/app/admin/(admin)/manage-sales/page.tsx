    ...
    <div className="h-full w-[1200px] bg-[#f8f8f8] pl-10 pt-9">
      <div className="">
        ...
        <div className="mt-9 flex gap-6 text-lg font-normal text-second">
          ...
          <div className="flex flex-col gap-5 ">
            ...
            {/* <input
						...
						/> */}
            <DatePicker format="DD/MM/YYYY" value={startDate} className="bg-third" onChange={handleChangeStartDate} />
          </div>
          <div className="flex flex-col gap-5 ">
            <p>Ngày kết thúc</p>
            {/* <input
						 ...
						 placeholder:text-second w-[264px] h-[48px] border-2 py-[18px] pl-6 pr-[30px] rounded-lg outline-0'
						/> */}
            <DatePicker format="DD/MM/YYYY" value={endDate} className="bg-third" onChange={handleChangeEndDate} />
          </div>
        ...
        <p className="my-2.5 text-lg font-normal text-second ">
          <span className="text-primary">*</span>Click vào mã hóa đơn để xem chi tiết hóa đơn.{' '}
        </p>
      </div>
          ...
          <table className="bg-third text-lg ">
            <thead className="text-primary ">
              <tr>
                ...
                <th className="border-b border-gray-200 py-4 text-center">Mã hóa đơn</th>
                <th className="border-b border-gray-200 py-4 text-center">Thời gian tạo hóa đơn</th>
                <th className="border-b border-gray-200 py-4 text-center">Tên khách hàng</th>
                <th className="border-b border-gray-200 py-4 text-center ">Tổng thanh toán</th>
                <th className="border-b border-gray-200 py-4 text-center">Trạng thái</th>
              ...
              {saleData &&
                saleData.map((sale) => (
                  <SaleDetail
                    ...
                    onStatusClick={() => handleCheckoutClick(sale._id, sale.user.username)}
                  />
                ))}
            </tbody>
          </table>
                ...
                <div className="relative mx-auto my-6 w-auto max-w-6xl">
                  ...
                  <div className="relative flex w-full flex-col rounded-lg border-0 bg-white shadow-lg outline-none focus:outline-none">
                    ...
                    <div className="border-blueGray-200 flex items-start justify-between rounded-t border-b border-solid p-5">
                      <h3 className="text-3xl font-semibold text-primary">4Food</h3>
                    </div>
                    {/*body*/}
                    <div className="relative grid flex-auto p-6">
                      <table className="bg-third text-lg ">
                        <thead className="text-primary ">
                          <th className="border-b border-gray-200 px-8 py-4 text-left">Mã hóa đơn</th>
                          <th className="border-b border-gray-200 px-8 py-4 text-left">Thời gian tạo hóa đơn</th>
                          <th className="border-b border-gray-200 px-8 py-4 text-left">Tên khách hàng</th>
                          <th className="border-b border-gray-200 px-8 py-4 text-left">Tổng thanh toán</th>
                          <th className="border-b border-gray-200 px-8 py-4 text-left">Trạng thái</th>
                        </thead>
                        <tbody>
                          <tr>
                            ...
                            <td className="border-b border-gray-200 px-8 py-4">19:40 - 08/11/2023</td>
                            <td className="border-b border-gray-200 px-8 py-4">Lê Tuấn Anh</td>
                            <td className="border-b border-gray-200 px-8 py-4">159.000 VND</td>
