        ...
        <div className="grid ">
          <table className="bg-third text-lg ">
            <thead className="text-primary ">
              <tr>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Mã bàn</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Tên bàn</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Vị trí</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Tình trạng</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Thời gian đặt</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Số lượng khách</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Tên</th>
                <th className="border-b border-gray-200 px-4 py-4 text-center">Số điện thoại</th>
              </tr>
            </thead>
            <tbody>
                  ...
                  <div className="relative my-6">
                    ...
                    <div className="relative flex w-full flex-col rounded-lg border-0 bg-white outline-none focus:outline-none">
                      ...
                      <div className="flex  justify-center p-5">
                        <h3 className="text-2xl font-medium text-primary ">Hủy bàn đã được đặt</h3>
                      </div>
                      {/*body*/}
