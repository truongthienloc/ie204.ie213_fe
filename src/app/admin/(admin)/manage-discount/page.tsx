...
export default function ManageDiscountPage() {
  ...
  const handleRemove = async () => {
    const removedDiscounts = discountData.filter((value) => value.isCheck).map((value) => value._id);
    try {
                    ...
                    <div className="relative my-6">
                      ...
                      <div className="relative flex w-full flex-col rounded-lg border-0 bg-white outline-none focus:outline-none">
                        ...
                        <div className="flex  justify-center border-b border-solid p-5">
                          <h3 className="text-2xl font-medium text-primary ">Sửa khuyến mãi</h3>
                        </div>
                        {/*body*/}
                        <div className="mt-4 flex flex-col justify-center gap-7 px-7   ">
                          <div className="flex items-center gap-8 text-lg ">
                            ...
                            <input
                              ...
                              onChange={editDiscountModal.handleChangeId}
                            />
                          </div>
                          <div className="flex items-center gap-8 text-lg ">
                            ...
                            <textarea
                              ...
                              onChange={editDiscountModal.handleChangeDescription}
                            ></textarea>
                          </div>
                          <div className="flex items-center gap-8 text-lg ">
                            ...
                            <input
                              ...
                              onChange={editDiscountModal.handleChangePercent}
                            />
                          </div>
                          <div className="flex items-center gap-8 text-lg ">
                            ...
                            <DatePicker
                              ...
                              onChange={editDiscountModal.handleChangeStartDay}
                            />
                          </div>
                          <div className="flex items-center gap-8 text-lg ">
                            ...
                            <DatePicker
                              ...
                              onChange={editDiscountModal.handleChangeEndDay}
                            />
                          </div>
                        </div>
                        {/*footer*/}
