...
export default function AdminChangePasswordPage() {
  ...
  const handleChangeCurPassword = (e: React.ChangeEvent<HTMLInputElement>) => setCurPassword(e.target.value);
  const handleChangeNewPassword = (e: React.ChangeEvent<HTMLInputElement>) => setNewPassword(e.target.value);
  const handleChangeRePassword = (e: React.ChangeEvent<HTMLInputElement>) => setRePassword(e.target.value);
        ...
        <div className="flex h-[540px] w-[420px] flex-col items-center justify-center gap-5 rounded-xl border-2 border-solid border-primary bg-[#FFEFD5]">
          ...
          <div>
            ...
            <div className="flex h-[42px] w-[300px] flex-row items-center justify-center rounded-md border-2 border-solid border-primary bg-third px-4 text-second">
              ...
              />
              {isShowCurPassword ? (
                <div className="cursor-pointer" id="eyeOpen" onClick={() => setIsShowCurPassword(togglePassword)}>
                  <VisibilityOffIcon />
                </div>
              ) : (
                <div className="cursor-pointer" id="eyeOpen" onClick={() => setIsShowCurPassword(togglePassword)}>
          ...
          <div>
            ...
            <div className="flex h-[42px] w-[300px] cursor-text flex-row items-center justify-center rounded-md border-2 border-solid border-primary bg-third px-4 text-second">
              ...
              />
              {isShowNewPassword ? (
                <div className="cursor-pointer" id="eyeOpen" onClick={() => setIsShowNewPassword(togglePassword)}>
                  <VisibilityOffIcon />
                </div>
              ) : (
                <div className="cursor-pointer" id="eyeOpen" onClick={() => setIsShowNewPassword(togglePassword)}>
          ...
          <div>
            ...
            <div className="flex h-[42px] w-[300px] cursor-text flex-row items-center justify-center rounded-md border-2 border-solid border-primary bg-third px-4 text-second">
              ...
              />
              <button className="cursor-pointer" id="eyeOpen" onClick={() => setIsShowRePassword(togglePassword)}>
