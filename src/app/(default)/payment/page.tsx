      ...
      <div className="flex flex-row justify-between gap-10 px-20">
        <div className="flex w-2/3 flex-col gap-5">
          <div className="flex flex-col">
            ...
            <ShippingOptionButtons state={isShip} updateStateTrue={toggleShipTrue} updateStateFalse={toggleShipFalse} />
          </div>
          <div className="flex flex-col">
            <h3 className="py-5 text-2xl text-primary">
          ...
          {isShip && (
            <div className="flex flex-col">
              ...
              <div className={`${style.inputDiv} ${isExistAddress ? style.active : ''}`}>
                <input type="text" placeholder="Địa chỉ giao hàng..." onChange={handleInputChange} />
              </div>
            </div>
          )}
