        ...
        {table ? (
          <>
            <div className={styles['table_content']}>
              ...
              <div>
                <span>Vị trí</span>
                <span className={styles['user_info']}>{table?.tablePosition + ' - ' + table?.tableFloor}</span>
              </div>
              <div>
                <span>Ngày đặt bàn</span>
                <span className={styles['user_info']}>{dayjs(table?.createdAt).format('DD/MM/YYYY')}</span>
              </div>
              <div>
                <span>Giờ đặt bàn</span>
                <span className={styles['user_info']}>{table?.user?.bookingTime}</span>
              </div>
              <div>
