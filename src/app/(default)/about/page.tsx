    ...
    <div className="pt-12">
      <animated.section ref={ref1} style={springProps1} className={cn(styles.wrap, 'row')}>
        <div className="col lg-6 md-12 text-justify text-xl leading-9 ">
          ...
          <p>
            Bếp UIT là cộng đồng tin cậy cho mọi người có thể tìm kiếm, đánh giá, bình luận các món ăn, thức uống tại
            UIT - từ website. Tất cả thành viên từ Web đến Data, Foody kết nối những thực khách đến với nới ăn uống lớn
            nhất UIT.
          </p>
          <p>
            Đến thời điểm hiện tại, Bếp UIT với hàng ngàn địa điểm và hàng chục ngàn bình luận, hình ảnh tại UIT, ở hầu
            hết các tỉnh thành. Bếp UIT là nơi ngon nhất để bạn có thể thưởng thức và lựa chọn địa điểm tốt nhất cho
            mình và bạn bè.
          </p>
        </div>
      ...
      <animated.section ref={ref2} style={springProps2} className={cn(styles.wrap, 'row')}>
        ...
        <div className="col lg-6 md-12 text-justify text-xl leading-9">
          ...
          <p className="mt-4">
            ...
            bàn một cách dễ dàng và tiện lợi. Quý khách có thể chọn ngày và giờ muốn đến, số lượng người tham dự và yêu
            cầu đặc biệt khác. Hệ thống sẽ tự động xác nhận thông tin đặt bàn của quý khách qua email hoặc tin nhắn, và
            đảm bảo chỗ ngồi sẽ sẵn sàng trong lúc quý khách đến.
          </p>
          <p className="mt-8">
            Tính năng đặt bàn online không chỉ giúp quý khách tiết kiệm thời gian mà còn tăng cường sự linh hoạt trong
            việc lựa chọn chỗ ngồi. Quý khách có thể xem trực tiếp thông tin của bàn và chọn vị trí phù hợp theo ý muốn.
            Đồng thời, quý khách cũng có thể xem trước thực đơn và các món ăn đặc biệt để chuẩn bị trước.
          </p>
        </div>
      </animated.section>
          ...
          <center>
            ...
            <div className="w-[80%] text-justify">
              <p className="mt-4 text-xl leading-9">
                ...
                Maps. Bằng cách này, chỉ cần một vài thao tác đơn giản trên điện thoại di động hoặc máy tính, khách hàng
                có thể tìm thấy vị trí chính xác của Bếp UIT trên bản đồ và nhận hướng dẫn chi tiết để đến đến từ bất kỳ
                nơi nào. Điều này tạo ra trải nghiệm thuận lợi và tiện ích, giúp khách hàng dễ dàng tiếp cận và khám phá
                các dịch vụ của Bếp UIT một cách nhanh chóng và dễ dàng.
              </p>
            </div>
            <iframe
      ...
      <animated.section ref={ref5} style={springProps5} className={cn(styles.wrap, 'row')}>
        ...
        <div className="col lg-6 md-12 text-justify text-xl leading-9 ">
          ...
          <p className="mt-4 text-xl leading-9">
            ...
            điều này giúp cộng đồng có cái nhìn tổng quan về các tiêu chí của mỗi địa điểm. Với tiêu chí luôn đặt khách
            hàng lên hàng đầu, chúng mình luôn đánh giá cao các bình luận và nhận xét để xây dựng Bếp UIT ngày càng phát
            triển và làm hài lòng tất cả mọi người.
          </p>
        </div>
      </animated.section>
