        ...
        {!isLoading ? (
          <div className="flex flex-col pb-5">
            <div className="w-fit py-5">
              <Link className="flex items-center text-lg hover:text-primary " href={'/product'}>
                <ArrowBackIosIcon />
            ...
            {!cartList.length ? (
              ...
              <>
                <TableContainer component={Paper} className="flex justify-center shadow-none">
                  <Table className="w-full" aria-label="customized table">
                    <TableHead className={styles['table_header']}>
                      <TableRow>
                        <StyledTableCell className="w-[200px]">Món ăn</StyledTableCell>
                ...
                <div className={`row ${styles.totalWrapper}`}>
                  <div className={`${styles.total} col lg-6 md-6 sm-6`}>
                    <div className="flex flex-row gap-8">
                      <h3 className="min-w-[120px] text-xl font-semibold text-primary">Cart</h3>
                      <p>{total} sản phẩm</p>
                    </div>
                    <div className="flex flex-row gap-8">
                  ...
                  <Link href={'/payment'} className={`${styles['checkout_btn']} col lg-6 md-6 sm-6`}>
